			...
			<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className=" hero max-w-4xl w-full relative z-10">
				...
				<div className="mt-8 flex justify-center">
					<div
						...
						className="p-4 bg-white/50 backdrop-blur-sm rounded-2xl border border-white/40 shadow-sm cursor-pointer hover:bg-white/80 transition-all duration-200 flex flex-col items-center justify-center"
					>
							...
							cards={[
								{
									...
									icon: <div className="w-full h-full bg-slate-800 rounded flex items-center justify-center p-1"><span className="text-white font-bold text-[10px] uppercase text-center leading-tight">Native<br/>Gardening</span></div>,
								},
							]}
						/>
					</div>
